    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto prose prose-emerald dark:prose-invert">
        ...
        <section className="mb-8">
          ...
          <p>
            Welcome to NoorBazaar. We respect your privacy and are committed to protecting your personal data. 
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            <br />
            Email: <a href="mailto:privacy@noorbazaar.pk">privacy@noorbazaar.pk</a>
          </p>
        </section>
      </div>
    </div>
